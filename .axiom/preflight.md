...
- [ ] **C2**: 当前代码在主分支上，且与远程同步（`git pull`）
- [ ] **C3**: 我已读取要修改文件的最新内容（没有用过期的上下文）
...
- [ ] **D7**: 我承诺不写TODO/FIXME占位符（R-011）
- [ ] **D8**: 我承诺修改文件前先Read获取最新内容（工具铁律1）
- [ ] **D9**: 我承诺Write/Edit后立即编译验证（工具铁律2）
- [ ] **D10**: 我承诺不写项目路径外的文件（工具铁律3）
