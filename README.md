...
axiom-kernel/
├── crates/
│   ├── axiom-kernel/          # 核心原语：Cell/Signal/Lens/Axiom/Witness + Layer/Entropy + Capability
│   │   ├── src/
│   │   │   ├── cell.rs
│   │   │   ├── signal.rs
│   │   │   ├── lens/        # Lens 子模块
...
✅ **v0.3.0 开发中** — 核心原语已稳定，运行时和 Agent 配套持续完善中。

## 设计文档

- [架构设计图](docs/architecture-diagram.md)
